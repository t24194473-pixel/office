    ...
    <header className="h-16 sm:h-20 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 flex flex-col justify-center px-4 sm:px-6 sticky top-0 z-30 transition-colors duration-300">
      ...
      <div className="hidden sm:flex items-center justify-between w-full">
        ...
        <div className="flex-1 max-w-md">
          <div className="flex w-full bg-gray-50 dark:bg-gray-800/50 border border-gray-200/60 dark:border-gray-700/50 rounded-full px-4 py-2.5 items-center gap-3 transition-all focus-within:bg-white dark:focus-within:bg-gray-800 focus-within:border-orange-300 dark:focus-within:border-orange-500 focus-within:ring-4 focus-within:ring-orange-100/50 dark:focus-within:ring-orange-500/20">
            <Search size={18} className="text-gray-400 dark:text-gray-500" />
            <input 
              type="text" 
              placeholder="ابحث عن المهام، المشاريع..." 
            ...
            />
            <div className="items-center justify-center bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded text-[10px] font-bold px-1.5 py-0.5">
              ⌘ + F
            </div>
          </div>
        </div>
